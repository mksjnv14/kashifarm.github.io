...
$message .= "<tr style='background: #eee;'><td><strong>Father Name:</strong> </td><td>" . strip_tags($_POST['fname']) . "</td></tr>";

$message .= "<tr style='background: #eee;'><td><strong>Mobile:</strong> </td><td>" . strip_tags($_POST['mobile']) . "</td></tr>";
$message .= "<tr style='background: #eee;'><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['email']) . "</td></tr>";
$message .= "<tr style='background: #eee;'><td><strong>Name:</strong> </td><td>" . strip_tags($_POST['place']) . "</td></tr>";
